        ...
        <div class="row justify-content-md-center">
            <div class="col-md-4">
                <form method="POST" action="#">
                  ...
                  <input type="tel" name="userMobile" class="form-control" id="number" value="<?php echo $_POST["name2"] ?>" placeholder=""  required    pattern="[789][0-9]{9}" oninvalid="Please Enter Proper Mobile Number" >
...
$apiKey = urlencode('epmHhCGGgb8-Z0YZwt0NnqQhxJ40ldWm59j4pkRapH');
